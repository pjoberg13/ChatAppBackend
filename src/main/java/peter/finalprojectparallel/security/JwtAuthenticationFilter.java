...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if(StringUtils.hasText(jwtFromRequest) && jwtProvider.validateToken(jwtFromRequest)) {
            ...
            //Constructing an instance of username/password auth token and storing inside Spring security context
    ...
    private String getJwtFromRequest(HttpServletRequest request) {
        //takes the word "Bearer" off the beginning of our bearer token and returns only the token itself
